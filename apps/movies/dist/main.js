...
async function bootstrap() {
    const app = await core_1.NestFactory.create(module_1.MoviesModule);
    const config = new swagger_1.DocumentBuilder().setTitle('Movies').setDescription('Movies API').setVersion('0.0.1').build();
